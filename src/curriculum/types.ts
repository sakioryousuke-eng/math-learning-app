...
export interface LearningCatalog {paperChoiceGrading?:boolean;master:Master;problems:Problem[];version:string;mainUnitIds:string[];reviewedOnly?:boolean;retiredSkillIds?:string[];stablePolicies?:Record<string,StablePolicy>;lessonMetadata?:ReviewedLesson[];}
