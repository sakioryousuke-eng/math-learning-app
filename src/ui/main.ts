...
function render(){
 ...
 if(devMode&&learning.namespace.startsWith('demo:preview:')&&s.screen==='problem'&&s.problem?.skillId.startsWith('QF-'))content+=`<details class="panel"><summary>答え・解説・グラフを直接確認</summary>${quadraticExplanation(s.problem)}</details>`;
