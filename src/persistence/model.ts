...
const assessment:z.ZodType<Assessment>=z.object({id,problemId:id,skillId:id,at,context:z.enum(['practice','diagnostic','warmup','repair','max']),solved:z.boolean(),readable:z.boolean(),independent:z.boolean(),integration:z.boolean(),tags:z.array(z.enum(errorTags)),dimensions:dimensionsSchema,crossSkills:z.record(rating)}).strict();
