...
export interface ReviewedLesson {
 ...
 review:{status:'reviewed'|'verified-generated';method:string;checks:string[]};
}
...
export interface ProblemGuide {problemId:string;roles:ProblemRole[];hideMethodLabel:boolean;reviewStatus:'legacy'|'representative_unvalidated'|'unreviewed'|'reviewed'|'verified-generated';}
export interface LearningCatalog {tratioBank?:import('../tratio-bank/types.ts').TratioBankRecord[];tratioSingleMax?:boolean;choiceSpecs?:Record<string,PaperSpec>;generatedBank?:BankRecord[];paperChoiceGrading?:boolean;master:Master;problems:Problem[];version:string;mainUnitIds:string[];reviewedOnly?:boolean;retiredSkillIds?:string[];stablePolicies?:Record<string,StablePolicy>;lessonMetadata?:ReviewedLesson[];}
