...
add('QF-INTEGRATE',1,'area','長さ12mの柵で長方形の三辺を囲み、残る一辺は壁を利用する。壁に垂直な辺をx mとし、1≦x≦4とする。(1)面積をxで表せ。(2)面積の最大値。(3)面積16m²以上となるxを求めよ。','S=x(12−2x),1≦x≦4。最大18m²(x=3)。2≦x≦4。','残る辺12−2xは区間全体で正。S=−2(x−3)²+18。頂点3が区間内なので最大18。S≧16は(x−3)²≦1、2≦x≦4。元の長さ条件と照合する。');
